    ...
    function createTooltip(frameDiv) {
        ...
        tooltip.prototype.showAt = function(position, message) {
            if(position && message) {
                ...
                this._div.style.left = position.x  + document.getElementById("map").offsetLeft + 10 + "px";
                this._div.style.top = (position.y - this._div.clientHeight / 2) + document.getElementById("map").offsetTop + "px";
            }
        }
